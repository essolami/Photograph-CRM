...
export type Permission = "canViewClients" | "canManageClients" | "canViewInvoices" | "canManageInvoices" | "canManageUsers";
...
export async function requirePermission(permission: Permission) {
  ...
  if (!user[permission]) throw new Error("You do not have permission to perform this action.");
  return user;
}
